...
\begin{figure}[htbp]
  ...
  \caption{RStudio password input.}
\end{figure}
...
\begin{figure}[htbp]
  ...
  \caption{Command line password input.}
\end{figure}
...
Always hash your passwords.  Some options for hashing with R include:
